...
INSERT INTO `otp` VALUES (22,1,'698038','password_reset','2026-04-15 03:39:12',1);
...
CREATE TABLE `requirements` (
  ...
  CONSTRAINT `requirements_ibfk_1` FOREIGN KEY (`userID`) REFERENCES `users` (`UserID`),
...
-- Dump completed on 2026-04-15  3:42:59
